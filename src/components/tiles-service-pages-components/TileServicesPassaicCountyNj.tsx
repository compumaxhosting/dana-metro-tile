...
const TileServicesPassaicCountyNj = () => {
  return (
      ...
      <section className="bg-[#403c38] px-4 py-16 text-center text-white sm:px-6 md:py-24">
        <div className="mx-auto max-w-4xl">
          <h1 className="text-font-cormorant mb-4 text-4xl leading-tight sm:text-5xl md:text-6xl">
            Tile Installation, Repair & Remodeling in <span className="text-caramel">Passaic County, NJ</span>
          </h1>
          <h2 className="text-font-cormorant mb-6 text-xl text-neutral-200 sm:text-2xl md:text-3xl">
            Residential & Commercial Tile Services Across Passaic County
          </h2>
          <p className="font-sans mx-auto max-w-3xl text-base leading-relaxed text-neutral-300 sm:text-lg">
            Tiles & Stones NJ provides residential and commercial tile services throughout Passaic County, NJ, including tile installation, repair, replacement, remodeling, floor installation, and floor tile repair.
          </p>
          <p className="font-sans mx-auto mt-4 max-w-3xl text-base leading-relaxed text-neutral-300 sm:text-lg">
            Whether you're updating a bathroom, remodeling a kitchen, installing a new tile floor, repairing damaged tile, or completing a commercial project, we focus on careful preparation, accurate layouts, precise cuts, consistent grout lines, and clean finishing.
          </p>
        ...
        <div className="mx-auto max-w-[1320px] grid gap-10 lg:grid-cols-2 lg:items-center lg:gap-16">
          ...
          <div className="order-1 lg:order-2">
            <img
              ...
              alt="Professional Tile Installation in Passaic County"
    ...
    Tiles & Stones
  </Link> NJ serves suitable residential and commercial projects throughout Passaic County, New Jersey, focusing on ceramic, porcelain, and large-format tile applications.
            </p>
        ...
        <div className="mx-auto max-w-[1320px]">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="font-sans mx-auto max-w-3xl text-base leading-relaxed text-neutral-700 sm:text-lg">
              Tiles & Stones NJ serves residential and commercial customers in Wayne, NJ and surrounding communities across Passaic County.
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:gap-12">
            ...
            <div className="bg-theme-cream p-6 shadow-sm transition-shadow hover:shadow-md sm:p-8 lg:p-10 border-l-4 border-caramel">
              ...
              <p className="font-sans mb-6 text-base leading-relaxed text-neutral-700">
                Our Passaic County service area includes Wayne, NJ and surrounding communities, subject to project location and scope.
              </p>
              <ul className="space-y-3 font-sans text-sm text-neutral-700 sm:text-base">
                <li className="flex items-start"><span className="text-caramel mr-2 mt-1 shrink-0">◆</span> Residential & Commercial tile services</li>
                ...
                <li className="flex items-start"><span className="text-caramel mr-2 mt-1 shrink-0">◆</span> Large-format & porcelain tile applications</li>
      ...
      <section className="bg-[#403c38] px-4 py-16 text-center text-white sm:px-6 md:py-24">
        <div className="mx-auto max-w-3xl">
          <h2 className="text-font-cormorant mb-4 text-3xl leading-tight sm:text-4xl">
            Planning a Tile Project in Passaic County?
          </h2>
          <p className="font-sans mb-4 text-base leading-relaxed text-neutral-300 sm:text-lg">
            Whether you're planning a new tile installation, remodeling an existing bathroom or kitchen, replacing a damaged floor tile, or repairing an existing tiled surface, Tiles & Stones NJ provides services for suitable residential and commercial projects.
          </p>
...
export default TileServicesPassaicCountyNj;