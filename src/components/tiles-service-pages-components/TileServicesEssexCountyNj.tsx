...
const TileServicesEssexCountyNj = () => {
  return (
      ...
      <section className="bg-[#403c38] px-4 py-16 text-center text-white sm:px-6 md:py-24">
        <div className="mx-auto max-w-4xl">
          <h1 className="text-font-cormorant mb-4 text-4xl leading-tight sm:text-5xl md:text-6xl">
            Tile Installation, Repair & Remodeling in <span className="text-caramel">Essex County, NJ</span>
          </h1>
          <h2 className="text-font-cormorant mb-6 text-xl text-neutral-200 sm:text-2xl md:text-3xl">
            Residential & Commercial Tile Services Across Essex County
          </h2>
          <p className="font-sans mx-auto max-w-3xl text-base leading-relaxed text-neutral-300 sm:text-lg">
            Tiles & Stones NJ provides residential and commercial tile services throughout Essex County, NJ, including tile installation, repair, replacement, remodeling, floor installation, and floor tile repair.
          </p>
          <p className="font-sans mx-auto mt-4 max-w-3xl text-base leading-relaxed text-neutral-300 sm:text-lg">
            Whether you're updating a bathroom, remodeling a kitchen, replacing damaged flooring, installing a backsplash, or planning a commercial tile project, we focus on careful preparation, accurate layouts, precise cuts, consistent grout lines, and clean finishing.
          </p>
          ...
          <div className="mt-10 pt-8 border-t border-neutral-700">
            ...
            <div className="flex flex-wrap justify-center gap-3 font-sans text-xs sm:gap-4 sm:text-sm">
              ...
              <Link 
                href="/services/tiles/passaic-county-nj"
                className="px-4 py-2 bg-neutral-800 text-neutral-200 shadow-sm border border-neutral-700 rounded-sm transition-colors hover:border-caramel hover:text-caramel hover:bg-theme-cream"
              >
                Passaic County, NJ
              </Link>
              <Link 
                href="/services/tiles/bergen-county-nj"
                className="px-4 py-2 bg-neutral-800 text-neutral-200 shadow-sm border border-neutral-700 rounded-sm transition-colors hover:border-caramel hover:text-caramel hover:bg-theme-cream"
              >
                Bergen County, NJ
              </Link>
              <Link 
                href="/services/tiles/morris-county-nj"
                className="px-4 py-2 bg-neutral-800 text-neutral-200 shadow-sm border border-neutral-700 rounded-sm transition-colors hover:border-caramel hover:text-caramel hover:bg-theme-cream"
              >
                Morris County, NJ
              </Link>
              <Link 
                href="/services/tiles/essex-county-nj"
        ...
        <div className="mx-auto max-w-[1320px] grid gap-10 lg:grid-cols-2 lg:items-center lg:gap-16">
          ...
          <div className="order-1 lg:order-2">
            <img
              ...
              alt="Professional Tile Installation in Essex County"
    ...
    Tiles & Stones
  </Link> NJ provides suitable residential and commercial tile services throughout Essex County, New Jersey, working with suitable ceramic, porcelain, and large-format tile applications.
            </p>
        ...
        <div className="mx-auto max-w-[1320px]">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="font-sans mx-auto max-w-3xl text-base leading-relaxed text-neutral-700 sm:text-lg">
              Essex County includes Belleville, Bloomfield, Caldwell, Cedar Grove, East Orange, Essex Fells, Fairfield, Glen Ridge, Irvington, Livingston, Maplewood, Millburn, Montclair, Newark, North Caldwell, Nutley, Orange, Roseland, South Orange, Verona, West Caldwell, and West Orange.
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:gap-12">
            ...
            <div className="bg-theme-cream p-6 shadow-sm transition-shadow hover:shadow-md sm:p-8 lg:p-10 border-l-4 border-caramel">
              <h3 className="text-font-cormorant mb-4 text-2xl text-caramel sm:text-3xl">Essex County</h3>
              <p className="font-sans mb-6 text-base leading-relaxed text-neutral-700">
                Tiles & Stones NJ provides tile installation, repair, remodeling, and flooring services for suitable residential and commercial projects throughout Essex County.
              </p>
              <ul className="space-y-3 font-sans text-sm text-neutral-700 sm:text-base">
                <li className="flex items-start"><span className="text-caramel mr-2 mt-1 shrink-0">◆</span> Bathroom & kitchen tile remodeling</li>
                <li className="flex items-start"><span className="text-caramel mr-2 mt-1 shrink-0">◆</span> Floor installation & individual tile repair</li>
                <li className="flex items-start"><span className="text-caramel mr-2 mt-1 shrink-0">◆</span> Ceramic, porcelain & large-format tile</li>
                <li className="flex items-start"><span className="text-caramel mr-2 mt-1 shrink-0">◆</span> Backsplash & shower tile installations</li>
                <li className="flex items-start"><span className="text-caramel mr-2 mt-1 shrink-0">◆</span> Tile replacement & grout finishing</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#403c38] px-4 py-16 text-center text-white sm:px-6 md:py-24">
        <div className="mx-auto max-w-3xl">
          <h2 className="text-font-cormorant mb-4 text-3xl leading-tight sm:text-4xl">
            Planning a Tile Project in Essex County?
          </h2>
...
export default TileServicesEssexCountyNj;