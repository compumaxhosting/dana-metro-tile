...
const TileServicesBergenCountyNj = () => {
  return (
      ...
      <section className="bg-[#403c38] px-4 py-16 text-center text-white sm:px-6 md:py-24">
        <div className="mx-auto max-w-4xl">
          <h1 className="text-font-cormorant mb-4 text-4xl leading-tight sm:text-5xl md:text-6xl">
            Tile Installation, Repair & Remodeling in <span className="text-caramel">Bergen County, NJ</span>
          </h1>
          <h2 className="text-font-cormorant mb-6 text-xl text-neutral-200 sm:text-2xl md:text-3xl">
            Residential & Commercial Tile Services Across Bergen County
          </h2>
          <p className="font-sans mx-auto max-w-3xl text-base leading-relaxed text-neutral-300 sm:text-lg">
            Tiles & Stones NJ provides residential and commercial tile services throughout Bergen County, NJ, including tile installation, repair, replacement, remodeling, floor installation, and floor tile repair.
          </p>
          <p className="font-sans mx-auto mt-4 max-w-3xl text-base leading-relaxed text-neutral-300 sm:text-lg">
            Whether you're updating a kitchen, remodeling a bathroom, installing a new tile floor, replacing damaged tile, or planning a commercial project, our work is focused on proper preparation, accurate layouts, precise cuts, consistent grout lines, and clean finishing.
          </p>
        ...
        <div className="mx-auto max-w-[1320px] grid gap-10 lg:grid-cols-2 lg:items-center lg:gap-16">
          ...
          <div className="order-1 lg:order-2">
            <img
              ...
              alt="Professional Tile Installation in Bergen County"
    ...
    Tiles & Stones
  </Link> NJ provides suitable residential and commercial tile services throughout Bergen County, New Jersey, working with suitable ceramic, porcelain, and large-format tile.
            </p>
        ...
        <div className="mx-auto max-w-[1320px]">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="font-sans mx-auto max-w-3xl text-base leading-relaxed text-neutral-700 sm:text-lg">
              Bergen County includes numerous municipalities, including Hackensack, Paramus, Fort Lee, Ridgewood, Teaneck, Fair Lawn, Mahwah, and many others.
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:gap-12">
            ...
            <div className="bg-theme-cream p-6 shadow-sm transition-shadow hover:shadow-md sm:p-8 lg:p-10 border-l-4 border-caramel">
              <h3 className="text-font-cormorant mb-4 text-2xl text-caramel sm:text-3xl">Bergen County</h3>
              ...
              <ul className="space-y-3 font-sans text-sm text-neutral-700 sm:text-base">
                <li className="flex items-start"><span className="text-caramel mr-2 mt-1 shrink-0">◆</span> Kitchen backsplash & bathroom tile</li>
                <li className="flex items-start"><span className="text-caramel mr-2 mt-1 shrink-0">◆</span> Floor tile installation & repair</li>
      ...
      <section className="bg-[#403c38] px-4 py-16 text-center text-white sm:px-6 md:py-24">
        <div className="mx-auto max-w-3xl">
          <h2 className="text-font-cormorant mb-4 text-3xl leading-tight sm:text-4xl">
            Planning a Tile Project in Bergen County?
          </h2>
          ...
          <p className="font-sans mb-10 text-sm text-neutral-400 sm:text-base">
            *Service availability depends on the project location and scope.
          </p>
          <a
            href="/contact"
...
export default TileServicesBergenCountyNj;